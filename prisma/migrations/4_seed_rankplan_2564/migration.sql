...
INSERT INTO "RankRule" ("planId","targetRank","metric","personalMin","teamMin","qualifiedUnits","qualifiedCenters","durationMinMonths","durationMaxMonths","licenseRequired","evalType","description","createdAt")
VALUES
('55555555-5555-4555-8555-555555555555',1,'commission',NULL,NULL,NULL,NULL,NULL,NULL,true,'approval','ตัวแทน: ขอ code + สอบใบอนุญาตตัวแทนประกันชีวิต — รายได้ค่าบำเหน็จ+ค่าพาหนะตามตารางผลิตภัณฑ์',NOW()),
('55555555-5555-4555-8555-555555555555',2,'commission',20000,NULL,NULL,NULL,1,6,false,'auto','ผบ.หน่วย: บำเหน็จ 20,000 บาท เวลา 1-6 เดือน',NOW()),
('55555555-5555-4555-8555-555555555555',3,'commission',75000,NULL,2,NULL,3,6,false,'auto','ผบ.ศูนย์: บำเหน็จ 75,000 บาท เวลา 3-6 เดือน แยกหน่วย 2 หน่วย',NOW()),
('55555555-5555-4555-8555-555555555555',4,'commission',1200000,NULL,NULL,4,12,24,false,'auto','ผบ.ภาค: บำเหน็จ 1,200,000 บาท เวลา 12-24 เดือน แยกศูนย์ 4 ศูนย์',NOW())
