...
export default function OneBreakFiveRulesPage(){
  const steps = [
    ...
    { icon:'🌐', title:'4. จัดวาง 1 แตก 5 ตามลำดับเวลา', body:'สมาชิกที่สแกนใบเสร็จก่อน → ขึ้นตำแหน่งก่อน → เข้าผัง 1 แตก 5 ก่อน (first-come-first-served) ไล่ไปจนถึงตำแหน่งสูงสุด (ผู้จัดการภาค)' },
  ];
  const waitRules = [
      ...
      <div className="flex w-full">
        ...
        <main className="flex-1 p-6 space-y-5 w-full min-w-0">
          ...
          <div className="card p-5">
            ...
            <div className="mt-2 text-xs text-slate-500">สมาชิกที่สแกนใบเสร็จก่อน → ขึ้นตำแหน่งก่อน → เข้าผัง 1 แตก 5 ก่อน ไล่ไปตามลำดับเวลาที่สแกน จนถึงตำแหน่งสูงสุด</div>
          </div>
