...
export default function OneBreakFiveRulesPage(){
  const steps = [
    ...
    { icon:'🧾', title:'2. สแกนใบเสร็จรับเงินตามการตั้งค่าของระบบ', body:'สแกน/อัปโหลดใบเสร็จรับเงิน ตามการตั้งค่าของระบบ ค่าคอม 20,000 บาท (สองหมื่นบาท) → ระบบตรวจ OCR + รับรองยอด แล้วบันทึกผลงานอัตโนมัติ' },
    ...
    { icon:'🌐', title:'4. จัดวาง 1 แตก 5 ตามลำดับเวลา', body:'สมาชิกที่สแกนใบเสร็จก่อน → ขึ้นตำแหน่งก่อน → เข้าผัง 1 แตก 5 ก่อน (first-come-first-served) ตามลำดับที่สแกนใบเสร็จก่อน จนถึงตำแหน่งสูงสุด (ผู้จัดการภาค)' },
  ];
  const waitRules = [
    ...
    'รอจนกว่าจะสแกนใบเสร็จรับเงิน ตามการตั้งค่าของระบบ ค่าคอม 20,000 บาท (สองหมื่นบาท) เข้ามา ถึงจะขึ้นตำแหน่งและเข้าระบบได้',
  ];
  const removeRules = [
        ...
        <main className="flex-1 p-6 space-y-5 w-full min-w-0">
          ...
          <div className="card p-5">
            ...
            <div className="mt-3 p-4 rounded-xl bg-[#eff6ff] border border-[#dbeafe] text-sm">
              สแกนใบเสร็จรับเงิน ตามการตั้งค่าของระบบ ค่าคอม <b>20,000 บาท (สองหมื่นบาท)</b>
              → ระบบ<b>แต่งตั้งเป็น "หัวหน้าหน่วย" อัตโนมัติ</b> และเข้าระบบ 1 แตก 5 ทันที
            </div>
            <div className="mt-2 text-xs text-slate-500">สมาชิกที่สแกนใบเสร็จก่อน → ขึ้นตำแหน่งก่อน → เข้าผัง 1 แตก 5 ก่อน ตามลำดับที่สแกนใบเสร็จก่อน จนถึงตำแหน่งสูงสุด</div>
          </div>
